...
| 타입       | 의미         | 예시                              |
| -------- | ---------- | ------------------------------- |
| ✨feat     | 새로운 기능 추가  | feat: 회원가입 페이지 UI 구현 (#12)  |
| 🔧fix      | 버그 수정      | fix: 로그인 API 에러 수정 (#34)    |
| 📄docs     | 문서 수정      | docs: README 업데이트 (#3)          |
| ♻️refactor | 코드 리팩토링    | refactor: API 응답 구조 개선 (#7) |
| ⚙️chore    | 빌드/설정 변경 등 | chore: eslint 설정 추가 (#2)    |

- ex) feat: 로그인 API 추가 (#12)
